...
public class State {
	...
	public static final int TOTAL_PIECES = 200000;

	

	public boolean lost = false;
	public static int[] myNextMove = new int[TOTAL_PIECES];
	public static int tolN = 0;
	...
	public State() {
		...
		try
		{
		    ...
		    br = new BufferedReader(new FileReader("moves1.txt"));
		    int cnt = 0;
		...
		nextPiece = randomPiece(tolN);
	}
	
	//random integer, returns 0-6
	private int randomPiece(int id) {
		return myNextMove[id];
	}
